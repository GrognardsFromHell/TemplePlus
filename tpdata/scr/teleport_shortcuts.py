...
def thrommel():
	game.fade_and_teleport(0,0,0,5105,554,449)
	return
def leucrottas():
	game.fade_and_teleport(0,0,0,5105,423,590)
	return
def lamia():
	game.fade_and_teleport(0,0,0,5105,603,608)
	return
def whitman():
	game.fade_and_teleport(0,0,0,5105,420,571)
	return
def mandy():
	game.fade_and_teleport(0,0,0,5105,420,571)
	return
def smigmal():
	game.fade_and_teleport(0,0,0,5105,632,470)
	return
def falrinth():
	game.fade_and_teleport(0,0,0,5105,632,470)
	return
def scorpp():
	game.fade_and_teleport(0,0,0,5105,553,490)
	return
