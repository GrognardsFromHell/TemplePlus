...
def	OnSpellEffect ( spell ):
	...
	game.particles('sp-Summon Natures Ally III', target_item.obj)
...
def OnBeginRound( spell ):
	print "Summon Nature's III OnBeginRound"

def OnEndSpellCast( spell ):
	print "Summon Nature's III OnEndSpellCast"
