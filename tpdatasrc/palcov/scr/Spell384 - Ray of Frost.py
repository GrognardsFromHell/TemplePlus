...
def OnEndProjectile( spell, projectile, index_of_target ):
	...
	if spell.caster.name == 14897:    # fog turtle
		spell.dc = 13                 # 10 + 0 + 3 (cha)
		spell.caster_level = 3
		num = max (1, int(group_average_level(game.leader)/2) )
		damage_dice = dice_new(str(num) + 'd6')
