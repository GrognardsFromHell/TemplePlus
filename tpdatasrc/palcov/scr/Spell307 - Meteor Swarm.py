...
def OnEndProjectile( spell, projectile, index_of_target ):
	...
	if index_of_target < projectiles:
		...
		if (return_val == 1) or (return_val == 2):
			...
			target_item.obj.spell_damage( spell.caster, D20DT_BLUDGEONING, dam, D20DAP_UNSPECIFIED, D20A_CAST_SPELL, spell.id )
			target_item.obj.spell_damage( spell.caster, D20DT_FIRE, dam2, D20DAP_UNSPECIFIED, D20A_CAST_SPELL, spell.id )
