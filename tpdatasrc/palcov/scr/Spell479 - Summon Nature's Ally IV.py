...
def	OnSpellEffect ( spell ):
	...
	game.particles('sp-Summon Natures Ally IV', target_item.obj)
...
def OnBeginRound( spell ):
	print "Summon Nature's IV OnBeginRound"

def OnEndSpellCast( spell ):
	print "Summon Nature's IV OnEndSpellCast"
