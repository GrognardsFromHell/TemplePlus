...
def	OnSpellEffect ( spell ):
	...
	game.particles('sp-Summon Natures Ally I', target_item.obj)
...
def OnBeginRound( spell ):
	print "Summon Nature's I OnBeginRound"

def OnEndSpellCast( spell ):
	print "Summon Nature's I OnEndSpellCast"
