...
def OnBeginSpellCast( spell ):
	print "Summon Nature's VIII OnBeginSpellCast"
	print "spell.target_list=", spell.target_list
	print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level
	game.particles( "sp-conjuration-conjure", spell.caster )

def	OnSpellEffect ( spell ):
	print "Summon Nature's VIII OnSpellEffect"
	teststr = "; summon nature's ally 8\n" #change this to the header line for the spell in spells_radial_menu_options.mes
...
def OnBeginRound( spell ):
	print "Summon Nature's VIII OnBeginRound"

def OnEndSpellCast( spell ):
	print "Summon Nature's VIII OnEndSpellCast"
