...
def OnBeginSpellCast( spell ):
	print "Ray of Entropy OnBeginSpellCast"
...
def	OnSpellEffect( spell ):
	print "Ray of Entropy OnSpellEffect"

def OnBeginRound( spell ):
	print "Ray of Entropy OnBeginRound"

def OnBeginProjectile( spell, projectile, index_of_target ):
	print "Ray of Entropy OnBeginProjectile"
...
def OnEndProjectile( spell, projectile, index_of_target ):
	print "Ray of Entropy OnEndProjectile"
	...
	if spell.caster.perform_touch_attack( target_item.obj ) & D20CAF_HIT:
		...
		target_item.obj.condition_add_with_args( 'sp-Bulls Strength', spell.id, spell.duration, dam_amount )
		target_item.obj.condition_add_with_args( 'sp-Endurance', spell.id, spell.duration, dam_amount )
...
def OnEndSpellCast( spell ):
	print "Ray of Entropy OnEndSpellCast"