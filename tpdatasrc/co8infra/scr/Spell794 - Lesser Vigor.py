...
def OnSpellEffect( spell ):
	...
	while(heal_count < spell.duration):
		game.timeevent_add( heal_tick_lesser_vigor, ( target.obj, dice ), (heal_count * heal_tick_time) )
...
def heal_tick_lesser_vigor( target , dice):
	print "Lesser Vigour Heal Tick"
