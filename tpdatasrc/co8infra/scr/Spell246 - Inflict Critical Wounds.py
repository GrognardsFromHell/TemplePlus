...
def OnBeginSpellCast( spell ):
	print "Inflict Critical Wounds OnBeginSpellCast"
	print "spell.target_list=", spell.target_list
	print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level
	game.particles( "sp-necromancy-conjure", spell.caster )

def OnSpellEffect( spell ):
	print "Inflict Critical Wounds OnSpellEffect"
	...
	game.particles( 'sp-Inflict Critical Wounds', target.obj )

	spell.target_list.remove_target( target.obj )
	spell.spell_end( spell.id )

def OnBeginRound( spell ):
	print "Inflict Critical Wounds OnBeginRound"

def OnEndSpellCast( spell ):
	print "Inflict Critical Wounds OnEndSpellCast"