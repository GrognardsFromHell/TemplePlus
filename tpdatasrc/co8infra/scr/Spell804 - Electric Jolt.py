...
def OnEndProjectile( spell, projectile, index_of_target ):
	...
	if return_val & D20CAF_HIT:
		...
		# hit
		target_item.obj.spell_damage_weaponlike( spell.caster, D20DT_ELECTRICITY, damage_dice, D20DAP_UNSPECIFIED, 100, D20A_CAST_SPELL, spell.id , return_val, index_of_target)
	else:
