...
###################################################
print "Registering race: Wood Elf"

raceEnum = race_elf + (5 << 5)

raceSpec = race_defs.RaceSpec()
raceSpec.hit_dice        = dice_new("0d0")
raceSpec.level_modifier  = 0
raceSpec.help_topic      = "TAG_WOOD_ELF"
raceSpec.flags           = 0
raceSpec.modifier_name   = "Wood Elf"
raceSpec.height_male     = [53, 65]
raceSpec.height_female   = [53, 65]
raceSpec.weight_male     = [87, 121]
raceSpec.weight_female   = [82, 116]
raceSpec.stat_modifiers  = [2, 2, -2, -2, 0, -2]   # str, dex, con, int, wis, cha
raceSpec.proto_id        = 13030
