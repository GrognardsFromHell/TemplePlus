...
spell_list = {
	...
	3: (spell_clairaudience_clairvoyance, spell_deep_slumber, spell_dispel_magic, spell_displacement, spell_glibness, spell_haste, spell_hold_person, spell_invisibility_sphere, spell_major_image, spell_nondetection, spell_slow, spell_suggestion, spell_inevitable_defeat),
