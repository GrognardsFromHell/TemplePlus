...
def OnBeginSpellCast(spell):
    print "Vigor, Mass Improved OnBeginSpellCast"
    print "spell.target_list=", spell.target_list
    print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level

def OnSpellEffect(spell):
    print "Vigor, Mass Improved OnSpellEffect"

    spell.duration = min(10 + 1 * spell.caster_level, 40)
...
def OnBeginRound(spell):
    print "Vigor, Mass Improved OnBeginRound"

def OnEndSpellCast(spell):
    print "Vigor, Mass Improved OnEndSpellCast"
