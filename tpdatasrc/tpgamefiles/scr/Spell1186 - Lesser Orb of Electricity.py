...
def OnBeginSpellCast(spell):
    print "Lesser Orb of Electricity OnBeginSpellCast"
    print "spell.target_list=", spell.target_list
    print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level

def OnSpellEffect(spell):
    print "Lesser Orb of Electricity OnSpellEffect"

def OnBeginRound(spell):
    print "Lesser Orb of Electricity OnBeginRound"

def OnBeginProjectile(spell, projectile, index_of_target):
    print "Lesser Orb of Electricity OnBeginProjectile"
    projectile.obj_set_int(obj_f_projectile_part_sys_id, game.particles("sp-Lesser Orb of Electricity-proj", projectile))

def OnEndProjectile(spell, projectile, index_of_target):
    print "Lesser Orb of Electricity OnEndProjectile"
...
def OnEndSpellCast(spell):
    print "Lesser Orb of Electricity OnEndSpellCast"
