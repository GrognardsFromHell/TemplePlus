...
def OnBeginSpellCast(spell):
    print "Lesser Orb of Sound OnBeginSpellCast"
    print "spell.target_list=", spell.target_list
    print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level

def OnSpellEffect(spell):
    print "Lesser Orb of Sound OnSpellEffect"

def OnBeginRound(spell):
    print "Lesser Orb of Sound OnBeginRound"

def OnBeginProjectile(spell, projectile, index_of_target):
    print "Lesser Orb of Sound OnBeginProjectile"
    projectile.obj_set_int(obj_f_projectile_part_sys_id, game.particles("sp-Lesser Orb of Cold-proj", projectile))

def OnEndProjectile(spell, projectile, index_of_target):
    print "Lesser Orb of Sound OnEndProjectile"
...
def OnEndSpellCast(spell):
    print "Lesser Orb of Sound OnEndSpellCast"
