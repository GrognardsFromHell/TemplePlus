...
def	OnSpellEffect ( spell ):
	...
	if spell.caster.map == 5061 and spell.caster.leader_get() == OBJ_HANDLE_NULL:
		spell_arg = 14884
...
def OnBeginRound( spell ):
	print "Summon Monster II OnBeginRound"

def OnEndSpellCast( spell ):
	print "Summon Monster II OnEndSpellCast"
