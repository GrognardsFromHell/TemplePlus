...
*/
  virtual bool GetBoneWorldMatrix(ObjHndl obj, const std::string &boneName,
                                  Matrix4x4 &boneMatrix) = 0;
...
*/
  virtual int GetParentChildBonePos(ObjHndl obj, int boneIdx, Vec3 &parentPos,
                                    Vec3 &childPos) = 0;
...
*/
  ...
  static IPartSysExternal *GetCurrent() { return mCurrent; }
