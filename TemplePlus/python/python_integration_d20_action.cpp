...
PYBIND11_EMBEDDED_MODULE(tpactions, m) {
	...
	py::class_<PickerArgs>(m, "PickerArgs")
		...
		.def_readwrite("flags_target", &PickerArgs::flagsTarget)
		.def_readwrite("include_flags", &PickerArgs::incFlags)
		.def_readwrite("exclude_flags", &PickerArgs::excFlags)
		.def_readwrite("min_targets", &PickerArgs::minTargets)
		.def_readwrite("max_targets", &PickerArgs::maxTargets)
		.def_readwrite("radius_target", &PickerArgs::radiusTarget)
		.def_readwrite("range", &PickerArgs::range)
		...
		.def("set_flags_target_flag", &PickerArgs::SetFlagsTargetFlag)
		.def("is_flags_target_flag_set", &PickerArgs::IsFlagsTargetFlagSet)
		.def("set_include_flag", &PickerArgs::SetIncludeFlag)
		.def("is_include_flag_set", &PickerArgs::IsIncludeFlagSet)
		.def("set_exclude_flag", &PickerArgs::SetExcludeFlag)
		.def("is_exclude_flag_set", &PickerArgs::IsExcludeFlagSet)
		;

	py::enum_<UiPickerType>(m, "ModeTarget", py::module_local())
		.value("NoTarget", UiPickerType::None)
		...
		;
	// FlagsTarget is a really bad name next to modetarget
	py::enum_<UiPickerFlagsTarget>(m, "FlagsTarget", py::module_local())
		.value("NoFlags", UiPickerFlagsTarget::None)
		.value("Min", UiPickerFlagsTarget::Min)
		.value("Max", UiPickerFlagsTarget::Max)
		.value("Radius", UiPickerFlagsTarget::Radius)
		.value("Range", UiPickerFlagsTarget::Range)
		.value("Exclude1st", UiPickerFlagsTarget::Exclude1st)
		.value("Degrees", UiPickerFlagsTarget::Degrees)
		.value("FixedRadius", UiPickerFlagsTarget::FixedRadius)
		.value("Unknown80h", UiPickerFlagsTarget::Unknown80h)
		.value("LosNotRequired", UiPickerFlagsTarget::LosNotRequired)
		;

	py::enum_<UiPickerIncFlags>(m, "IncludeFlags", py::module_local())
		.value("NoInc", UiPickerIncFlags::UIPI_None)
