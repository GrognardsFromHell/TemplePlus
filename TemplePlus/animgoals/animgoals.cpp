...
{
	static auto GoalStateCallback1 = temple::GetPointer<std::remove_pointer<GoalCallback>::type>(0x1000c9c0);
	static auto GoalStateCallback3 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000ccf0);
	static auto GoalSetOffAndDestroyParam1 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000ce10);
	static auto GoalParam1ObjCloseToParam2Loc = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000ce60);
	...
	static auto GoalFindPathNearObject = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000e8b0);
	static auto GoalFindPathNearObjectCombat = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000ec10);
	static auto GoalIsParam1Door = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000efb0);
	static auto GoalPlayDoorLockedSound = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f000);
	static auto GoalIsDoorMagicallyHeld = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f0d0);
	static auto GoalAttemptOpenDoor = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f140);
	static auto GoalIsDoorLocked = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f2c0);
	static auto GoalDoorAlwaysFalse = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f350);
	static auto GoalIsDoorUnlocked = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f400);
	static auto GoalSetRadiusTo2 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f490);
	static auto GoalUseObject = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f550);
	static auto GoalUseItemOnObj = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f860);
	static auto GoalUseItemOnObjWithSkillDummy = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x1000f9a0);
	...
	static auto GoalPickLock = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10010b90);
	static auto GoalAttemptTrapDisarm = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10010cd0);
	static auto GoalActionPerform2 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10010d60);
	static auto GoalHasReachWithMainWeapon = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10010e00);
	static auto GoalThrowItem = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10010f70);
	static auto GoalNotPreventedFromTalking = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100110a0);
	static auto GoalIsWithinTalkingDistance = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100111e0);
	static auto GoalInitiateDialog = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100112d0);
	static auto GoalOpenDoorCleanup = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10011370);
	static auto GoalCloseDoorCleanup = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10011420);
	static auto GoalIsDoorSticky = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100114d0);
	static auto GoalIsLiveCritterNear = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10011530);
	...
	static auto GoalSaveStateDataInSkillData = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10011d20);
	static auto GoalSaveStateDataOrSpellRangeInRadius = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10011d40);
	static auto GoalSetTargetLocFromObj = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10011dc0);
	static auto GoalSetRadiusTo4 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10011e70);
	static auto GoalSetRadiusToAiSpread = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10011e90);
	static auto GoalIsCloserThanDesiredSpread = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10011f20);
	...
	static auto GoalLoopWhileCloseToParty = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10012fa0);
	static auto GoalFreeSoundHandle = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10013080);
	static auto GoalIsAliveAndConscious = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100130f0);
	static auto GoalBeginMoveStraight = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10013250);
	static auto GoalUpdateMoveStraight = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10013af0);
	static auto GoalSetNoBlockIfNotInParty = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100140c0);
	static auto GoalDyingCleanup = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10014170);
	static auto GoalMoveAlongPath = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100147d0);
	static auto GoalIsNotStackFlagsData20 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10014f10);
	static auto GoalJiggleAlongYAxis = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10014f30);
	static auto GoalStartJigglingAlongYAxis = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10014ff0);
	static auto GoalEndJigglingAlongYAxis = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100150a0);
	static auto GoalIsNotStackFlagsData40 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10015150);
	static auto GoalSetSlotFlags4 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10015170);
	static auto GoalActionPerform3 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10015240);
	static auto GoalSpawnFireball = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10017100);
	static auto GoalPleaseMove = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10017170);
	static auto GoalIsTargetWithinRadius = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10017460);
	static auto GoalWander = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10017570);
	static auto GoalWanderSeekDarkness = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10017810);
	static auto GoalIsDoorFullyClosed = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10017b30);
	static auto GoalTriggerSpell = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10017dd0);
	static auto GoalUnconcealCleanup = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10017f80);
	static auto GoalResetToIdleAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10018050);
	...
	static auto GoalContinueWithAnim2 = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100189b0);
	static auto GoalPlayDoorOpenAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10018a70);
	static auto GoalContinueWithDoorOpenAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10018b90);
	static auto GoalPlayDoorCloseAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10018c50);
	static auto GoalContinueWithDoorCloseAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10018d40);
	static auto GoalPickLockPlayPushDoorOpenAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10018e00);
	static auto GoalPickLockContinueWithAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10018ee0);
	static auto GoalDyingPlaySoundAndRipples = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10018fa0);
	static auto GoalDyingContinueAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019070);
	static auto GoalAnimateFireDmgContinueAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019130);
	static auto GoalStunnedPlayAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100191f0);
	static auto GoalStunnedContinueAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019330);
	static auto GoalPlayGetUpAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019470);
	static auto GoalPlayUnconcealAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019540);
	static auto GoalPlayMoveAnim = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019630);
	static auto GoalPlayWaterRipples = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019920);
	static auto GoalContinueMoveStraight = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x100199b0);
	static auto GoalApplyKnockback = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019c20);
	static auto GoalDyingReturnTrue = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019e10);
	static auto GoalAttemptMoveCleanup = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019e70);
	static auto GoalAttackPlayWeaponHitEffect = temple::GetRef<std::remove_pointer<GoalCallback>::type>(0x10019f00);
	...
	attempt_spell_w_cast_anim.AddState(GoalIsSlotFlag10NotSet) // Index 0
		...
		.OnSuccess(T_GOTO_STATE(10))
		.OnFailure(T_GOTO_STATE(1));
	attempt_spell_w_cast_anim.AddState(GoalUnconcealAnimate) // Index 1
		.SetArgs(AGDATA_SELF_OBJ)
		.OnSuccess(T_GOTO_STATE(3))
		.OnFailure(T_GOTO_STATE(7), DELAY_SLOT);
	...
	attempt_spell_w_cast_anim.AddState(GoalSlotFlagSet8If4AndNotSetYet) // Index 3
		.SetArgs(AGDATA_SELF_OBJ, AGDATA_ANIM_ID_PREV)
		.OnSuccess(T_GOTO_STATE(13))
		.OnFailure(T_REWIND, DELAY_SLOT);
	attempt_spell_w_cast_anim.AddState(GoalReturnFalse) // Index 4
		.SetArgs(AGDATA_SKILL_DATA)
		.OnSuccess(T_GOTO_STATE(5))
		.OnFailure(T_GOTO_STATE(8));
	attempt_spell_w_cast_anim.AddState(GoalSpawnFireball) // Index 5
		.SetArgs(AGDATA_SELF_OBJ, SELF_OBJ_PRECISE_LOC)
		.SetFlagsData(5)
		.OnSuccess(T_GOTO_STATE(6))
		.OnFailure(T_GOTO_STATE(7));
	attempt_spell_w_cast_anim.AddState(GoalStateCallback1) // Index 6
		.SetArgs(AGDATA_SCRATCH_OBJ, AGDATA_SELF_OBJ)
		.SetFlagsData(38)
		.OnSuccess(T_REWIND, DELAY_SLOT)
		.OnFailure(T_POP_ALL, DELAY_SLOT);
	attempt_spell_w_cast_anim.AddState(AlwaysSucceed) // Index 7
		...
		.OnSuccess(T_POP_GOAL)
		.OnFailure(T_POP_ALL);
	attempt_spell_w_cast_anim.AddState(GoalAttemptSpell) // Index 8
		.SetArgs(AGDATA_SELF_OBJ, AGDATA_SKILL_DATA)
		.OnSuccess(T_REWIND)
		.OnFailure(T_GOTO_STATE(7));
	attempt_spell_w_cast_anim.AddState(GoalActionPerform3) // Index 9
		.SetArgs(AGDATA_SELF_OBJ)
		.SetFlagsData(1)
		.OnSuccess(T_POP_ALL)
		.OnFailure(T_POP_ALL);
	...
	attempt_spell_w_cast_anim.AddState(GoalAttemptSpell) // Index 12
		...
		.OnSuccess(T_POP_ALL)
		.OnFailure(T_POP_ALL);
	attempt_spell_w_cast_anim.AddState(GoalWasInterrupted) // Index 13
		.SetArgs(AGDATA_SELF_OBJ)
		.OnSuccess(T_GOTO_STATE(10))
