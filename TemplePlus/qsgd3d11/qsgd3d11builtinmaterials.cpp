...
#include "qsgd3d11builtinmaterials_p.h"
...
QSGMaterialType QSGD3D11VertexColorMaterial::mtype;

QSGMaterialType *QSGD3D11VertexColorMaterial::type() const
{
    return &QSGD3D11VertexColorMaterial::mtype;
}

int QSGD3D11VertexColorMaterial::compare(const QSGMaterial *other) const
{
    Q_UNUSED(other);
...
int QSGD3D11VertexColorMaterial::constantBufferSize() const
{
    return QSGD3D11Engine::alignedConstantBufferSize(VERTEX_COLOR_CB_SIZE);
}

void QSGD3D11VertexColorMaterial::preparePipeline(QSGD3D11PipelineState *pipelineState)
{
...
QSGD3D11Material::UpdateResults QSGD3D11VertexColorMaterial::updatePipeline(const QSGD3D11MaterialRenderState &state,
                                                                            QSGD3D11PipelineState *,
                                                                            ExtraState *,
                                                                            quint8 *constantBuffer)
{
    QSGD3D11Material::UpdateResults r = 0;
...
QSGD3D11FlatColorMaterial::QSGD3D11FlatColorMaterial()
    : m_color(QColor(255, 255, 255))
{
}

QSGMaterialType QSGD3D11FlatColorMaterial::mtype;

QSGMaterialType *QSGD3D11FlatColorMaterial::type() const
{
    return &QSGD3D11FlatColorMaterial::mtype;
}

int QSGD3D11FlatColorMaterial::compare(const QSGMaterial *other) const
{
    Q_ASSERT(other && type() == other->type());
    const QSGD3D11FlatColorMaterial *o = static_cast<const QSGD3D11FlatColorMaterial *>(other);
...
int QSGD3D11FlatColorMaterial::constantBufferSize() const
{
    return QSGD3D11Engine::alignedConstantBufferSize(FLAT_COLOR_CB_SIZE);
}

void QSGD3D11FlatColorMaterial::preparePipeline(QSGD3D11PipelineState *pipelineState)
{
...
QSGD3D11Material::UpdateResults QSGD3D11FlatColorMaterial::updatePipeline(const QSGD3D11MaterialRenderState &state,
                                                                          QSGD3D11PipelineState *,
                                                                          ExtraState *,
                                                                          quint8 *constantBuffer)
{
...
void QSGD3D11FlatColorMaterial::setColor(const QColor &color)
{
    m_color = color;
    setFlag(Blending, m_color.alpha() != 0xFF);
}

QSGD3D11SmoothColorMaterial::QSGD3D11SmoothColorMaterial()
{
    setFlag(RequiresFullMatrixExceptTranslate, true);
    setFlag(Blending, true);
}

QSGMaterialType QSGD3D11SmoothColorMaterial::mtype;

QSGMaterialType *QSGD3D11SmoothColorMaterial::type() const
{
    return &QSGD3D11SmoothColorMaterial::mtype;
}

int QSGD3D11SmoothColorMaterial::compare(const QSGMaterial *other) const
{
    Q_UNUSED(other);
    Q_ASSERT(other && type() == other->type());
    return 0;
...
int QSGD3D11SmoothColorMaterial::constantBufferSize() const
{
    return QSGD3D11Engine::alignedConstantBufferSize(SMOOTH_COLOR_CB_SIZE);
}

void QSGD3D11SmoothColorMaterial::preparePipeline(QSGD3D11PipelineState *pipelineState)
{
...
QSGD3D11Material::UpdateResults QSGD3D11SmoothColorMaterial::updatePipeline(const QSGD3D11MaterialRenderState &state,
                                                                            QSGD3D11PipelineState *,
                                                                            ExtraState *,
                                                                            quint8 *constantBuffer)
{
...
QSGMaterialType QSGD3D11TextureMaterial::mtype;

QSGMaterialType *QSGD3D11TextureMaterial::type() const
{
    return &QSGD3D11TextureMaterial::mtype;
}

int QSGD3D11TextureMaterial::compare(const QSGMaterial *other) const
{
    Q_ASSERT(other && type() == other->type());
    const QSGD3D11TextureMaterial *o = static_cast<const QSGD3D11TextureMaterial *>(other);
...
int QSGD3D11TextureMaterial::constantBufferSize() const
{
    return QSGD3D11Engine::alignedConstantBufferSize(TEXTURE_CB_SIZE);
}

void QSGD3D11TextureMaterial::preparePipeline(QSGD3D11PipelineState *pipelineState)
{
...
QSGD3D11Material::UpdateResults QSGD3D11TextureMaterial::updatePipeline(const QSGD3D11MaterialRenderState &state,
                                                                        ...
                                                                        quint8 *constantBuffer)
{
    ...
    QSGD3D11TextureView &tv(pipelineState->shaders.rootSig.textureViews[0]);
    if (m_filtering == QSGTexture::Linear)
        tv.filter = m_mipmap_filtering == QSGTexture::Linear
                ? QSGD3D11TextureView::FilterLinear : QSGD3D11TextureView::FilterMinMagLinearMipNearest;
    else
        tv.filter = m_mipmap_filtering == QSGTexture::Linear
                ? QSGD3D11TextureView::FilterMinMagNearestMipLinear : QSGD3D11TextureView::FilterNearest;
    tv.addressModeHoriz = m_horizontal_wrap == QSGTexture::ClampToEdge ? QSGD3D11TextureView::AddressClamp : QSGD3D11TextureView::AddressWrap;
    tv.addressModeVert = m_vertical_wrap == QSGTexture::ClampToEdge ? QSGD3D11TextureView::AddressClamp : QSGD3D11TextureView::AddressWrap;
...
void QSGD3D11TextureMaterial::setTexture(QSGTexture *texture)
{
    m_texture = texture;
    setFlag(Blending, m_texture ? m_texture->hasAlphaChannel() : false);
}

QSGD3D11SmoothTextureMaterial::QSGD3D11SmoothTextureMaterial()
{
    setFlag(RequiresFullMatrixExceptTranslate, true);
    setFlag(Blending, true);
}

QSGMaterialType QSGD3D11SmoothTextureMaterial::mtype;

QSGMaterialType *QSGD3D11SmoothTextureMaterial::type() const
{
    return &QSGD3D11SmoothTextureMaterial::mtype;
}

int QSGD3D11SmoothTextureMaterial::compare(const QSGMaterial *other) const
{
    Q_ASSERT(other && type() == other->type());
    const QSGD3D11SmoothTextureMaterial *o = static_cast<const QSGD3D11SmoothTextureMaterial *>(other);
    if (int diff = m_texture->textureId() - o->texture()->textureId())
        return diff;
    return int(m_filtering) - int(o->m_filtering);
}
...
int QSGD3D11SmoothTextureMaterial::constantBufferSize() const
{
    return QSGD3D11Engine::alignedConstantBufferSize(SMOOTH_TEXTURE_CB_SIZE);
}

void QSGD3D11SmoothTextureMaterial::preparePipeline(QSGD3D11PipelineState *pipelineState)
{
...
QSGD3D11Material::UpdateResults QSGD3D11SmoothTextureMaterial::updatePipeline(const QSGD3D11MaterialRenderState &state,
                                                                              QSGD3D11PipelineState *pipelineState,
                                                                              ExtraState *,
                                                                              quint8 *constantBuffer)
{
...
QSGD3D11TextMaterial::QSGD3D11TextMaterial(StyleType styleType, QSGD3D11RenderContext *rc,
      ...
      m_rc(rc)
{
    ...
    if (QFontEngine *fontEngine = fontD->fontEngine) {
        ...
        QSGD3D11Engine *d3dengine = rc->engine();
        ...
        if (!m_glyphCache || int(m_glyphCache->glyphFormat()) != glyphFormat) {
            m_glyphCache = new QSGD3D11GlyphCache(d3dengine, glyphFormat, glyphCacheTransform);
...
QSGMaterialType QSGD3D11TextMaterial::mtype[QSGD3D11TextMaterial::NTextMaterialTypes];

QSGMaterialType *QSGD3D11TextMaterial::type() const
{
    ...
    return &QSGD3D11TextMaterial::mtype[matStyle + matFormat];
}

int QSGD3D11TextMaterial::compare(const QSGMaterial *other) const
{
    Q_ASSERT(other && type() == other->type());
    const QSGD3D11TextMaterial *o = static_cast<const QSGD3D11TextMaterial *>(other);
...
int QSGD3D11TextMaterial::constantBufferSize() const
{
    return QSGD3D11Engine::alignedConstantBufferSize(TEXT_CB_SIZE);
}

void QSGD3D11TextMaterial::preparePipeline(QSGD3D11PipelineState *pipelineState)
{
...
QSGD3D11Material::UpdateResults QSGD3D11TextMaterial::updatePipeline(const QSGD3D11MaterialRenderState &state,
                                                                     QSGD3D11PipelineState *pipelineState,
                                                                     ...
                                                                     quint8 *constantBuffer)
{
    ...
    if (glyphCache()->glyphFormat() == QFontEngine::Format_A32) {
        ...
        pipelineState->blend = QSGD3D11PipelineState::BlendColor;
    ...
    QSGD3D11TextureView &tv(pipelineState->shaders.rootSig.textureViews[0]);
    tv.filter = QSGD3D11TextureView::FilterNearest;
    tv.addressModeHoriz = QSGD3D11TextureView::AddressClamp;
    tv.addressModeVert = QSGD3D11TextureView::AddressClamp;
...
void QSGD3D11TextMaterial::populate(const QPointF &p,
                                    ...
                                    const QMargins &margins)
{
    ...
    QSGD3D11GlyphCache *cache = glyphCache();
    QRawFontPrivate *fontD = QRawFontPrivate::get(m_font);
