...
QSGD3D11InternalRectangleNode::QSGD3D11InternalRectangleNode()
{
    setMaterial(&m_material);
}

void QSGD3D11InternalRectangleNode::updateMaterialAntialiasing()
{
    if (m_antialiasing)
...
void QSGD3D11InternalRectangleNode::updateMaterialBlending(QSGNode::DirtyState *state)
{
