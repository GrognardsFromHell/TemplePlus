...
class QSGD3D11SpriteMaterial : public QSGD3D11Material
{
public:
    QSGD3D11SpriteMaterial();
    ~QSGD3D11SpriteMaterial();
    ...
    {
        return this - static_cast<const QSGD3D11SpriteMaterial *>(other);
    }

    int constantBufferSize() const override;
    void preparePipeline(QSGD3D11PipelineState *pipelineState) override;
    UpdateResults updatePipeline(const QSGD3D11MaterialRenderState &state,
...
QSGD3D11SpriteMaterial::QSGD3D11SpriteMaterial()
    : texture(nullptr),
      animT(0.0f),
      animX1(0.0f),
      animY1(0.0f),
...
int QSGD3D11SpriteMaterial::constantBufferSize() const
{
    return QSGD3D11Engine::alignedConstantBufferSize(SPRITE_CB_SIZE);
}

void QSGD3D11SpriteMaterial::preparePipeline(QSGD3D11PipelineState *pipelineState)
{
...
QSGD3D11Material::UpdateResults QSGD3D11SpriteMaterial::updatePipeline(const QSGD3D11MaterialRenderState &state,
                                                                       QSGD3D11PipelineState *,
                                                                       ExtraState *,
                                                                       quint8 *constantBuffer)
{
    QSGD3D11Material::UpdateResults r = UpdatedConstantBuffer;
...
QSGD3D11SpriteNode::QSGD3D11SpriteNode()
    : m_material(new QSGD3D11SpriteMaterial)
...
void QSGD3D11SpriteNode::setTexture(QSGTexture *texture)
{
...
void QSGD3D11SpriteNode::setTime(float time)
{
    m_material->animT = time;
    markDirty(DirtyMaterial);
}

void QSGD3D11SpriteNode::setSourceA(const QPoint &source)
{
    if (m_sourceA != source) {
        m_sourceA = source;
...
void QSGD3D11SpriteNode::setSourceB(const QPoint &source)
{
    if (m_sourceB != source) {
        m_sourceB = source;
...
void QSGD3D11SpriteNode::setSpriteSize(const QSize &size)
{
...
void QSGD3D11SpriteNode::setSheetSize(const QSize &size)
{
    if (m_sheetSize != size) {
        m_sheetSize = size;
...
void QSGD3D11SpriteNode::setSize(const QSizeF &size)
{
    if (m_size != size) {
        m_size = size;
        m_geometryDirty = true;
...
void QSGD3D11SpriteNode::setFiltering(QSGTexture::Filtering filtering)
{
    m_material->texture->setFiltering(filtering);
    markDirty(DirtyMaterial);
}

void QSGD3D11SpriteNode::update()
{
    if (m_geometryDirty) {
...
void QSGD3D11SpriteNode::updateGeometry()
{
