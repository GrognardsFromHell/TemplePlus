...
#ifndef QSGD3D11GLYPHCACHE_P_H
#define QSGD3D11GLYPHCACHE_P_H
...
class QSGD3D11GlyphCache : public QTextureGlyphCache
{
public:
    QSGD3D11GlyphCache(QSGD3D11Engine *engine, QFontEngine::GlyphFormat format, const QTransform &matrix);
    ~QSGD3D11GlyphCache();
