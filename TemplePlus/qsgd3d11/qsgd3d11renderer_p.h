...
#ifndef QSGD3D11RENDERER_P_H
#define QSGD3D11RENDERER_P_H
...
class QSGD3D11Renderer : public QSGRenderer
{
public:
    QSGD3D11Renderer(QSGRenderContext *context);
    ~QSGD3D11Renderer();
...
private:
    ...
    void setInputLayout(const QSGGeometry *g, QSGD3D11PipelineState *pipelineState);
    ...
    QSGD3D11Engine *m_engine = nullptr;

    QSGMaterialType *m_lastMaterialType = nullptr;
    QSGD3D11PipelineState m_pipelineState;
    QSGD3D11PipelineState m_freshPipelineState;

    typedef QHash<QSGNode *, QSGD3D11MaterialRenderState::DirtyStates> NodeDirtyMap;
