...
#ifndef QSGD3D11BUILTINMATERIALS_P_H
#define QSGD3D11BUILTINMATERIALS_P_H
...
#include "qsgd3d11glyphcache_p.h"
...
class QSGD3D11VertexColorMaterial : public QSGD3D11Material
{
public:
...
class QSGD3D11FlatColorMaterial : public QSGD3D11Material
{
public:
    QSGD3D11FlatColorMaterial();
    QSGMaterialType *type() const override;
    int compare(const QSGMaterial *other) const override;
...
class QSGD3D11SmoothColorMaterial : public QSGD3D11Material
{
public:
    QSGD3D11SmoothColorMaterial();
    QSGMaterialType *type() const override;
    int compare(const QSGMaterial *other) const override;
...
class QSGD3D11TextureMaterial : public QSGD3D11Material
{
public:
    QSGMaterialType *type() const override;
    int compare(const QSGMaterial *other) const override;
...
class QSGD3D11SmoothTextureMaterial : public QSGD3D11Material
{
public:
    QSGD3D11SmoothTextureMaterial();
...
class QSGD3D11TextMaterial : public QSGD3D11Material
{
public:
    enum StyleType {
        Normal,
    ...
    QSGD3D11TextMaterial(StyleType styleType, QSGD3D11RenderContext *rc, const QRawFont &font,
    ...
    QSGD3D11GlyphCache *glyphCache() const { return static_cast<QSGD3D11GlyphCache *>(m_glyphCache.data()); }

private:
    static const int NTextMaterialTypes = NStyleTypes * 2;
    static QSGMaterialType mtype[NTextMaterialTypes];
    StyleType m_styleType;
    QSGD3D11RenderContext *m_rc;
    QVector4D m_color;
...
#endif // QSGD3D11BUILTINMATERIALS_P_H
