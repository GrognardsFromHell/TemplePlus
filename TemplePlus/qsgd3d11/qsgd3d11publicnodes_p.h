...
#ifndef QSGD3D11PUBLICNODES_P_H
#define QSGD3D11PUBLICNODES_P_H
...
class QSGD3D11RectangleNode : public QSGRectangleNode
{
public:
    QSGD3D11RectangleNode();
...
private:
    ...
    QSGD3D11FlatColorMaterial m_material;
};

class QSGD3D11ImageNode : public QSGImageNode
{
public:
    QSGD3D11ImageNode();
    ~QSGD3D11ImageNode();
...
class QSGD3D11NinePatchNode : public QSGNinePatchNode
{
public:
    QSGD3D11NinePatchNode();
    ~QSGD3D11NinePatchNode();
