...
#ifndef QSGD3D11CONTEXT_P_H
#define QSGD3D11CONTEXT_P_H
...
class QSGD3D11Context : public QSGContext
{
public:
    QSGD3D11Context(QObject *parent = 0) : QSGContext(parent) { }
