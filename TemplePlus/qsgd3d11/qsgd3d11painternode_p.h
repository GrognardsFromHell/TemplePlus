...
#ifndef QSGD3D11PAINTERNODE_P_H
#define QSGD3D11PAINTERNODE_P_H
...
class QSGD3D11PainterTexture : public QSGD3D11Texture
{
public:
    QSGD3D11PainterTexture(QSGD3D11Engine *engine);
...
class QSGD3D11PainterNode : public QSGPainterNode
{
public:
    QSGD3D11PainterNode(QQuickPaintedItem *item);
    ~QSGD3D11PainterNode();
...
private:
    ...
    QSGD3D11Engine *m_engine;
    QSGD3D11PainterTexture *m_texture;
    QSize m_size;
    QSize m_textureSize;
    ...
    QSGD3D11TextureMaterial m_material;
